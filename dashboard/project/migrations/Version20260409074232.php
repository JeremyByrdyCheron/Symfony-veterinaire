...
final class Version20260409074232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE request (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, animal VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, submitted_date DATE NOT NULL, description LONGTEXT NOT NULL, wanted_date DATE NOT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, phone_number INT NOT NULL, animal_folder_id_id INT DEFAULT NULL, veterinary_id_id INT DEFAULT NULL, INDEX IDX_3B978F9FA09A5461 (animal_folder_id_id), INDEX IDX_3B978F9F450FF95C (veterinary_id_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
